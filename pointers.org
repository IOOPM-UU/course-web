...
use. We will look at [[file:assignments/lists.org][linked lists]] as our driving example, because
...
When we implemented [[file:assignments/lists.org][linked lists]], we used a clever trick of

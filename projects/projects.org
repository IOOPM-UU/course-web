...
The project may start at December 2th, but not earlier. The
project will be handed in no later than 24 hours /before/ the
seminar. For example, if your team's seminar is on the 16th of
January at 15:00, the strict deadline is January 15th, at 15:00.
...
2020/21, there are exactly four holidays (December 24 and 25, 
January 1 and 5), in addition to weekends. Feel free to handle this
...
"voted of the Island". Talk to the head teacher if the need arises.
...
[[./project-report.org][is found here]].** Using this template, you will be asked to reflect
...
1500--3000 characters. Note -- all character counts in this
...
#+begin_danger
Below are the project specifications used in 2018 and 2019 (and in
some cases before). We may completely change these during 2020.
The project specifications will be locked down at the latest
November 25.
#+end_danger

If nothing else is stated, then the projects are required to work
on Linux X86 64 bit, Ubuntu 18.04 (which is what the department
...
The full project description is [[./project1.org][here]].
...
The full project description is [[./project2.org][here]].

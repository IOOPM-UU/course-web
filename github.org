...
Once you have a GitHub account, simply click on the GitHub icon in
the AU Portal. This will prompt an authentication song-and-dance
with GitHub which ultimately allows us to read your user name from
GitHub and attach to your repository. 

** 3. Tacka ja till inbjudan

Så snart du har skickat in dina uppgifter kommer vi att lägga till
dig i vår GitHub-organisation. Du kommer då att få ett mejl med en
inbjudan:

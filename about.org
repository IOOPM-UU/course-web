...
* DONE Changes from 2017
** Changelog
- Completely new Assignment 1 ::
     Assignment 1 is now a cross-breed of traditional labs and
     traditional assigments. The idea is to provide some more
     safety and also steer thoughts a bit, but not have small
     tasks that are too well-aligned to one or two specific
     concepts.
...
** New things 2017 that we are keeping
...
redovisas. 2018 finns ca 43 mål på nivå 3, 18 mål på nivå 4 och

...
*This will be updated for Lecture 4*

# ** Changelog
# 1. Completely new Assignment 1 
# 2. Overhaul of Assignment 2--4
# 3. New course website
# 4. Stricter group meetings
# 5. New vagrant machine for using own laptops/computers 
# 6. Changed Emacs shortcuts and settings 
# 7. New lecture material on some lectures 
# ** Rooms for Improvement 
# 1. Queuing time on labs -- not solved 
...
programmeringspar. [[file:team.org::*Group%20Meetings][Läs mer här]].
** Labbar
#+begin_important
...
# via en essä (för högre betyg). Du kan läsa om den bland [[file:achievements.org::*59][målen]].
...
When in doubt, ask [[file:tas2018.org::*Head%20Teacher:%20Tobias%20Wrigstad][Tobias]]. 

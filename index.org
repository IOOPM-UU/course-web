...
* IOOPM Communication Channels and Course Tools
...
probably [[./about.org][read the page about the course first]]. [[mark:Mandatory reading!]]
...
- Get a [[./github.org::*How to Get a GitHub Account for the Course][GitHub account and let us know about its username]] so we
  can connect it to the course. Once this is done, you should
  [[./github.org::*Checking Out the Repository for the First Time][check out your GitHub repository]].

...
defintion of correctness for that code. By starting with the
...
- For each step, we start by defining the success critera of that
...
Future tests will test the correctness of the implementatation of
...
haunt us if we ever need to change the internal repesentation.
Instead, for now, let us as a test simply verify that a newly
created hash table is completely empty. 

We can draw on our knowledge of the interal representation in our
choice of lookup uperations. If we know that the number of bucket
...
comment. The number 18 is seeminlgy "magical" -- it is likely not
...
https://en.wikipedia.org/wiki/File:TDD_Global_Lifecycle.png
#+CAPTION: The lifecycle of test-driven design (from Wikipedia)
...
6. [[file:../github.org][Check your code into the approprate GitHub repos]]. Tag your
...
is to change the behavious of the function so that it returns, not
...
5. [[file:../github.org][Check your code into the approprate GitHub repos]]. Tag your
...
7. [[file:../github.org][Check your code into the approprate GitHub repos]]. Tag your
...
4. [[file:../github.org][Check your code into the approprate GitHub repos]]. Tag your
...
9. [[file:../github.org][Check your code into the approprate GitHub repos]]. Tag your
...
7. Run your tests through Valgrind. Preferably using a [[../makefiles.org][Makefile]].
8. Make sure that the code passes your tests.
9. [[file:../github.org][Check your code and the profiling results into the approprate

...
*Soft deadline*: End of Week 41 \\
*Hard deadline*: End of Week 43
#+end_important
...
- Create multiple opportunities to [[../about.org::*Redovisning och AU-Portalen][demonstrate mastery of
  achievements.]]
...
*For now, we will [[../simple.org::dodge][dodge]] and consider only lists that store
...
or use a single free to free more than one block. (See [[../misc/l%C3%A4nkade strukturer, notation och free.pdf][this slide
...
steps etc. In the past, some students were confused by this as they
...
fine choice. For now, we will [[../simple.org::dodge][dodge]] and consider only lists that
...
arbitrary data. We will follow the trick in [[./lists.org::*Adding Genericity][the text on linked
...
which allows us to rewrite the above as ~ioopm_hash_table_insert(ht, int_elem(42), ptr_elem("4711"))~. 
...
1. Go over your backlog of [[../simple.org::cheat][cheats]] and [[../simple.org::dodge][dodges]] and see which ones

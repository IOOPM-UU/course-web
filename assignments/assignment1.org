...
- Create multiple opportunities to [[~/t/ioopm/2018/site/about.org::*Redovisning%20och%20AU-Portalen][demonstrate mastery of
  achievements.]]
...
2. You should have found a [[~/t/ioopm/2018/site/pair-programming.org][partner to work with from your team]].
3. You should have [[~/t/ioopm/2018/site/github.org][gotten a GitHub repo *from the course*]].
...
Following the [[file:~/c/ioopm/site/simple.org][SIMPLE methodology]], we are going to /dodge/ and
...
fprogram like so: =gcc -pedantic -Wall -g gdb-test.c= ([[file:~/c/ioopm/site/compiling.org][read about
...
character ([[file:~/t/ioopm/2018/site/pointers.org][if your mind boggles at the thought of a pointer to
...
1. Handle failing lookups by one of the alternatives above
   ...
   the [[file:../glossary.org][signature]] of the function (changing the return type
...
- [[file:~/t/ioopm/2018/site/misc/hash_table.h][=hash_table.h=]]
- [[file:~/t/ioopm/2018/site/misc/list.h][=list.h=]]
- [[file:~/t/ioopm/2018/site/misc/iterator.h][=iterator.h=]]

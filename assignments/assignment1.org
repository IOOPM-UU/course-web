...
#+CAPTION: Newly initialised hash with inlined dummy entries with 4 => bar, 17 => foo and 208 => baz. The entry with key 4 is the /previous entry/ of the entry with key 208.
#+NAME: fig_ht_4
#+RESULTS:

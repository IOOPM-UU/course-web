...
~srand()~ med ett s.k. /seed/, dvs. input till en funktion som ser
...
Jag rekommenderar att du *inte* använder ~srand()~ på kursen
eftersom det gör det svårare att felsöka ditt program om du t.ex.
inte kan lita på gissa-talet-programmet stabilt drar 4711 ur
hatten varje gång...
#+end_note
...
1. key:C-x [[key:&minus;]] för att dela (det aktuella) fönstret horizontellt
2. key:C-x [[key:&mid;]] för att dela (det aktuella) fönstret vertikalt
...
(En modifierad version av detta program var nyligen på ett [[file:~/t/ioopm/2018/site/code-exam.org][kodprov]].)
...
När du har tagit en paus är det dags för [[file:assignment1.org][inlämningsuppgift 1]]!
#+end_note

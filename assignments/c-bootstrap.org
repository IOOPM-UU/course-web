...
24 timmar av de [[http://www.wisdomgroup.com/blog/10000-hours-of-practice/][10.000 timmar]] som behövs för att bli en expert på
programmering, och du kommer vara väl förberedd på att läsa resten
av kursen.
...
räcker det med att skriva upp sig på tavlan i 1515* och visa vad
du har gjort. Förbered gärna ett litet körexempel!
...
- [[file:~/t/ioopm/2018/site/editors.org#Introduktion%20till%20Emacs][Introduktion till Emacs]]
- [[file:~/t/ioopm/2018/site/screencasts.org#Screencasts%20om%20verktyg][Screencasts om Emacs]]
- [[file:~/t/ioopm/2018/site/misc/cheatsheet.pdf][Emacs lathund]]
...
2. Skriv en loop som skriver ut /N/ stycken brädgårdar (för något
   värde på /N/).

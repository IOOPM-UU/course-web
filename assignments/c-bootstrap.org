...
deadline, hör av dig till en [[file:~/t/ioopm/2018/site/tas2018.org][senior assistent]] eller till Tobias så
...
As a guide to the personal programming process, [[file:~/t/ioopm/2018/site/simple.org][we recommend
following the steps of the SIMPLE programming methodology]]. It
...
Even if you have programming experience from before, please [[file:~/t/ioopm/2018/site/simple.org][take a
look at SIMPLE]]!
...
Emacs-resurser på denna webbsida: 
- [[file:../editors.org::*Introduktion%20till%20Emacs][Introduktion till Emacs]]
- [[file:../screencasts.org::*Screencasts%20om%20verktyg][Screencasts om Emacs]]
- [[file:../site/misc/cheatsheet.pdf][Emacs lathund]]
...
Börja med att skapa filen =hello.c= så här: [[key:C-x]] [[key:C-f]]
...
mummel som kompilatorn spottar ur sig. ([[file:~/t/ioopm/2018/site/compiling.org::*Compiling%20C%20Code][Läs mer om att kompilera C-program här!]])
...
#+BEGIN_SRC c
int read_string(char *buf, int buf/siz)
#+END_SRC
...
#+begin_warning
På vissa maskiner fungerar ~rand()~ bättre än ~random()~.
#+end_warning
...
den användas tillsammans med ~foldl/int/int~. För att skicka med
...
~foldl/int/int()~ och ~add()~. Du behöver inte ändra i vare sig
~foldl/int/int()~ eller ~add()~.
...
Typen ~answer/t~ avser ett värde som /antingen/ är en ~int~ /eller_
...
*Fråga:* [[quiz:Alternativ%201%20%C3%A4r%20korrekt.][Vad skriver detta program ut på skärmen när det körs?]]
...
[[quiz:Genom%20att%20definiera%20om%20nyckelfunktioner%20f%C3%B6r%20att%20t.ex.%20ta%20ett%20extra%20argument%20kan%20du%20f%C3%A5%20kompilatorn%20att%20driva%20f%C3%B6r%C3%A4ndringsarbetet.%20][Kan C:s kompilator hjälpa dig på något sätt?]]
...
det, följ [[file:~/t/ioopm/2018/site/github.org][dessa instruktioner]]. Här ska du ladda upp alla uppgifter
...
online. Du hittar några av dem i vårt [[file:links.org][länkbibliotek]]. Det finns
också en [[file:~/t/ioopm/2018/site/github.org][kortare lathund]] med de vanligaste Git-kommandona.
...
du har tagit en paus är det dags för [[file:assignment1.org][inlämningsuppgift 1]]!
#+END_CENTER

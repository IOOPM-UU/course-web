...
- [[../editors.org::*Introduktion%20till%20Emacs][Introduktion till Emacs]]
- [[../screencasts.org::*Screencasts%20om%20verktyg][Screencasts om Emacs]]
...
lista på ett vettigt sätt. Här fokuserar vi på några viktiga skillnader
som brukar vara förvirrande i början:
...
enkelt att konstruerar program där ordningen i vilket argument
...
mummel som kompilatorn spottar ur sig. ([[../compiling.org::*Compiling%20C%20Code][Läs mer om att kompilera C-program här!]])

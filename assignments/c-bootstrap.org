...
uppgifter ska redovisas för en labbassistent över Zoom med hjälp
av AU-portalen. Senare under kursens kommer redovisningarna vara
mer utförliga men bara snabbt stega igenom och visa vad du har
gjort. Förbered gärna ett litet körexempel!
...
Det är obligatoriskt att göra dem och redovisa dem innan du får
börja redovisa något annat framsteg på kursen.
...
det labbtillfälle de ges (under vecka 1 och 2). Varje labbs /mjuka
...
** Steg 1: Kom igång med AWS

Börja med att [[http://wrigstad.com/ioopm/auportal.html#org16e61b3][logga in i AU-portalen]]. 

1. Gå igenom First-Time Set-Up (info i länken ovan)
2. Länka ditt konto till GitHub  (info i länken ovan)
3. Sätt upp din Cloud 9-miljö (info i länken ovan)

Observera att länk-steget mot GitHub kan ta någon minut. 

** Steg 2: Länka GitHub och Cloud 9
...
din katalog för IOOPM är =ioopm=. Det finns redan en tom
katalogstruktur för att lägga filer i.

Ta dig till ditt GitHub-repo genom att klicka på GitHub-ikonen i
AU-portalen, efter att du länkat mot GitHub enligt ovan. *Klicka
på den gröna knappen med texten "Code", och kopiera instruktionen
för "Clone with HTTPS" (Står det "Clone with SSH" kan du klicka på
länken "Use HTTPS" för at växla.[fn::Clone with SSH är egentligen
bättre men kräver att du har en publik nyckel uppladdat på GitHub.
Så småningom under kursen vill du nog göra det för att slippa
skriva lösenord hela tiden.])
...
#+begin_example
$ git clone https://github.com/IOOPM-UU/first.last.1234 ioopm  # Allt utom clone bör du ha i urklipp
$ touch labbar/lab1/hello.c                                    # Skapar en tom hello.c
#+end_example

Nu kan du använda menyerna i editorn för att öppna
=labbar/lab1/hello.c= och editera.
...
Börja med att öppna filen =hello.c=. Det finns många sätt att
...
#+begin_hint
Använd [[key:Ctrl-Alt-B]] för att formattera all kod. 
#+end_hint
...
genom att gå till terminalen och skriva =cp p1.c p2.c= eller via
...
#+begin_hint
Du kan använda key:Ctrl-g för att hoppa till en speciell rad i
filen.
#+end_hint

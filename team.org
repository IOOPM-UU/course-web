...
En gång varje sprint skall du gå på ett uppföljningsmöte, som din
coach kallar till. Till detta möte skall du ta med dig åtminstone:
...
till coachen och till [[file:tas2018.org][huvudassistenten]], och CC:as till samtliga i
teamet. Denna rapport skall vara mycket kortfattad och innehålla:
...
7. "Underskrifter" på samtliga närvarande

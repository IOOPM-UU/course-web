...
- 2019-02-19 ([[Reactions to Student Feedback][Reactions to Student Feedback]]). 
- 2019-02-26 ([[Some Data Mining Results][Some Data Mining Results]])
- 2019-03-25 (Fixing a stupid copy-paste bug in §4.4.2 -- thanks Martin E.!)
- 2019-04-02 (Moved the footer to the right place -- thanks Linus S.!)

[[https://github.com/IOOPM-UU/course-web/blob/master/course-report2018.org][The entire change history is visible on GitHub]]. 
...
*** How Much Code Do Students Write
Pulling the repositories of the active students, I did a rough
guesstimate as to how much code students write on the course (not
counting the project). This only includes code checked into the
master branch, does not include deleted lines, but may include
duplicates due to copy and paste.
...
This suggests that each student /pair/ writes on average 170 LOC
(Lines Of Code) per full-time working day (remember the course
runs at 66% speed) during the first two phases.

*** Demonstrations
Here is a histogram showing how many demonstrations the average
student did. (*FIXME*) This histogram starts at 6 demonstration and
therefore leaves out a number of students doing a very small
number of demonstrations. These are predominantly old students
showing up and finishing a few remaining achievements, typically
some assignment plus 1--2 more achievements.

#+CAPTION: Demonstrations done by students in 2018/2019
file:images/cr18/demo-histogram.png
